...
const AesEncryptionValuesSecretKeyPageDocumentation = () => {
  return (
    <div>
      <Typography paragraph>
        ...
        , we define a random generated secret key, which is fed to the Cipher. We only encrypt
...
export default AesEncryptionValuesSecretKeyPageDocumentation;